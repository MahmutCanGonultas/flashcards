...
export const ELEMENTARY: Record<string, TopicBody> = {
  "noun-adjective-verb": {
    ...
    quiz: [
      { kind: "choice", prompt: "Hangisi bir fiil (verb)?", options: ["happy", "run", "table"], answer: 1, explain: "**run** (koşmak) bir eylem." },
      ...
      { kind: "order", tr: "Küçük bir evde yaşıyoruz.", answer: "We live in a small house.", extra: ["smalls"], explain: "Sıfat ismin önünde ve çoğul olmaz." },
      { kind: "order", tr: "Bu kahve çok sert.", answer: "This coffee is very strong.", extra: ["strongly"], explain: "is'ten sonra sıfat: **strong**." },
      { kind: "choice", prompt: "Hangisi bir isim (noun)?", options: ["decide", "decision", "decisive"], answer: 1, explain: "-sion / -tion ile bitenler genelde isim: **decision**." },
    ],
  },
  ...
  "simple-present": {
    ...
    quiz: [
      ...
      { kind: "choice", prompt: "___ [she] speak English?", tr: "İngilizce konuşur mu?", options: ["Do", "Does", "Is"], answer: 1, explain: "She → **Does**." },
      ...
      { kind: "choice", prompt: "Does your mum drive? — Yes, she ___.", tr: "Annen araba kullanır mı? — Evet, kullanır.", options: ["does", "do", "drives"], answer: 0, explain: "Kısa cevap: Yes, she **does**." },
      { kind: "order", tr: "Her sabah yürüyüşe çıkarım.", answer: "I go for a walk every morning.", extra: ["goes"], explain: "I → **go** (-s yok). Zaman sonda." },
      { kind: "order", tr: "Kardeşim et yemez.", answer: "My brother doesn't eat meat.", extra: ["eats"], explain: "doesn't'tan sonra yalın fiil: **eat**." },
  ...
  "wh-questions": {
    ...
    quiz: [
      ...
      { kind: "type", prompt: "___ are you laughing?", tr: "Neden gülüyorsun?", answer: ["Why"], explain: "Neden → **Why**." },
      ...
      { kind: "order", tr: "Film saat kaçta başlıyor?", answer: "What time does the film start?", extra: ["starts"], explain: "Wh + **does** + özne + yalın fiil." },
      { kind: "order", tr: "Bu çanta kimin?", answer: "Whose bag is this?", extra: ["Who"], explain: "Kimin → **Whose**." },
      { kind: "choice", prompt: "How ___ is this coat?", tr: "Bu mont ne kadar?", options: ["much", "many", "long"], answer: 0, explain: "Fiyat: How **much**." },
    ],
  },
  ...
  "sentence-building": {
    ...
    quiz: [
      ...
      { kind: "type", prompt: "___ am hungry.", tr: "Açım.", answer: ["I"], explain: "Özne şart: **I** am hungry." },
      ...
      { kind: "order", tr: "Her gün evde İngilizce çalışırım.", answer: "I study English at home every day.", extra: ["studies"], explain: "Özne + fiil + nesne + yer + zaman." },
      { kind: "order", tr: "Çocuklar parkta futbol oynuyor.", answer: "The children play football in the park.", extra: ["plays"], explain: "Fiil öznenin hemen arkasında." },
      { kind: "order", tr: "Dün akşam sinemada bir film izledik.", answer: "We watched a film at the cinema last night.", extra: ["watch"], explain: "Ne → nerede → ne zaman." },
  ...
  "to-by-from": {
    ...
    quiz: [
      ...
      { kind: "type", prompt: "This song is ___ Tarkan.", tr: "Bu şarkı Tarkan'ın.", answer: ["by"], explain: "Yapan kişi: **by**." },
      { kind: "choice", prompt: "Hangisi doğru?", options: ["I go to home after work.", "I go home after work.", "I go at home after work."], answer: 1, explain: "home ile to yok: **go home**." },
      { kind: "order", tr: "Her gün trenle işe giderim.", answer: "I go to work by train every day.", extra: ["from"], explain: "to work (nereye) + by train (nasıl)." },
      { kind: "order", tr: "Bu mektup annemden.", answer: "This letter is from my mother.", extra: ["to"], explain: "Gönderen: **from**." },
  ...
  numbers: {
    ...
    quiz: [
      ...
      { kind: "type", prompt: "12 = ___", answer: ["twelve"], explain: "12 = **twelve**." },
      { kind: "type", prompt: "90 = ___", answer: ["ninety"], explain: "9 = nine → **ninety** (e kalır)." },
      { kind: "choice", prompt: "'Thirteen' hangi sayı?", options: ["30", "13", "3"], answer: 1, explain: "-teen: **13**. (30 = thirty)" },
      { kind: "choice", prompt: "Hangisi doğru yazılmış?", options: ["twenty-one", "twenty and one", "twentyone"], answer: 0, explain: "Tire ile: **twenty-one**." },
      ...
      { kind: "order", tr: "Otuz dört yaşındayım.", answer: "I am thirty-four years old.", extra: ["have"], explain: "Yaş be ile: I **am** thirty-four." },
  ...
  "ordinals-frequency": {
    ...
    quiz: [
      ...
      { kind: "choice", prompt: "Hangisi doğru?", options: ["I go always to bed late.", "I always go to bed late.", "Always I go late to bed."], answer: 1, explain: "Sıklık sözü fiilin önünde: I **always** go…" },
      ...
      { kind: "type", prompt: "My birthday is on the ___ of March. (1)", tr: "Doğum günüm bir martta.", answer: ["first", "1st"], explain: "1 → **first**." },
      ...
      { kind: "choice", prompt: "'Nadiren' hangisi?", options: ["rarely", "usually", "always"], answer: 0, explain: "**rarely** = nadiren." },
      { kind: "order", tr: "Genellikle işe otobüsle giderim.", answer: "I usually go to work by bus.", extra: ["always"], explain: "Sıklık sözü fiilin önünde." },
      { kind: "order", tr: "Günde üç kez kahve içerim.", answer: "I drink coffee three times a day.", extra: ["once"], explain: "Sayı + times + a day." },
