...
export const PRE_INTERMEDIATE: Record<string, TopicBody> = {
  "likes-dislikes": {
    ...
    quiz: [
      ...
      { kind: "order", tr: "Babam yüksek sesli müziğe dayanamaz.", answer: "My dad can't stand loud music.", extra: ["stands", "doesn't"], explain: "Hiç çekemem: **can't stand** + isim." },
  ...
  "countable-uncountable": {
    ...
    quiz: [
      ...
      { kind: "type", prompt: "Can I have a ___ of bread?", tr: "Bir dilim ekmek alabilir miyim?", answer: ["slice", "piece"], explain: "a **slice** of bread (a piece of bread da olur)." },
      { kind: "choice", prompt: "Hangi cümle yanlış?", options: ["I need some information.", "She gave me two advices.", "We bought new furniture."], answer: 1, explain: "advice çoğul olmaz: two **pieces of advice**." },
      { kind: "order", tr: "Bir şişe süt ve iki elma aldım.", answer: "I bought a bottle of milk and two apples.", extra: ["milks", "apple"], explain: "Süt sayılamaz (a bottle of), elma sayılır (two apples)." },
  ...
  quantifiers: {
    ...
    quiz: [
      ...
      { kind: "choice", prompt: "There's ___ milk left — we need to buy some.", tr: "Neredeyse hiç süt kalmadı, almamız lazım.", options: ["little", "a little", "a few"], answer: 0, explain: "Yetmeyecek kadar az (sayılamayan): **little**. a little 'biraz, yeter' demek." },
  ...
  "linking-words": {
    ...
    quiz: [
      ...
      { kind: "choice", prompt: "Hangi cümle yanlış?", options: ["Although it was cold, we swam.", "Although it was cold, but we swam.", "It was cold, but we swam."], answer: 1, explain: "although ile but birlikte kullanılmaz." },
      { kind: "type", prompt: "You can have tea ___ coffee, not both.", tr: "Çay ya da kahve alabilirsin, ikisini birden değil.", answer: ["or"], explain: "Seçenek: **or**." },
      ...
      { kind: "order", tr: "Yorgundum, o yüzden erken yattım.", answer: "I was tired, so I went to bed early.", extra: ["because", "but"], explain: "Sonuç: **so**." },
      { kind: "order", tr: "Hastaydım çünkü yağmurda yürüdüm.", answer: "I was ill because I walked in the rain.", extra: ["so", "and"], explain: "Sebep: **because**." },
