...
export const BEGINNER: Record<string, TopicBody> = {
  "to-be": {
    ...
    quiz: [
      { kind: "choice", prompt: "[I] ___ a teacher.", tr: "Ben öğretmenim.", options: ["am", "is", "are"], answer: 0, explain: "I her zaman **am** alır." },
      ...
      { kind: "choice", prompt: "[The cat] ___ on the sofa.", tr: "Kedi kanepede.", options: ["are", "is", "am"], answer: 1, explain: "The cat = it → **is**." },
      { kind: "type", prompt: "[We] ___ late again!", tr: "Yine geç kaldık!", answer: ["are"], explain: "We → **are**." },
      { kind: "type", prompt: "[He] ___ not at home.", tr: "Evde değil.", answer: ["is"], explain: "He → **is**; olumsuzda arkasından not gelir." },
      ...
      { kind: "choice", prompt: "Hangisi doğru?", options: ["Yes, I'm.", "Yes, I am.", "Yes, I is."], answer: 1, explain: "Olumlu kısa cevap kısaltılmaz: **Yes, I am.**" },
      { kind: "order", tr: "Ben yorgun değilim.", answer: "I am not tired.", extra: ["is"], explain: "I + **am** + not + tired." },
      { kind: "order", tr: "Kız kardeşim doktor.", answer: "My sister is a doctor.", extra: ["are"], explain: "My sister = she → **is**. Meslekten önce a gelir." },
  ...
  "possessive-s-of": {
    ...
    quiz: [
      ...
      { kind: "type", prompt: "This is my ___ room.", tr: "Bu erkek kardeşimin odası. (brother)", answer: ["brother's"], explain: "Tek kişi: **brother's**." },
      { kind: "choice", prompt: "Hangisi doğru?", options: ["the end of the film", "the film of end", "the end the film"], answer: 0, explain: "Eşya için: the end **of** the film." },
      ...
      { kind: "order", tr: "Ali'nin arabası kırmızı.", answer: "Ali's car is red.", extra: ["of"], explain: "Sahip + **'s** + sahip olunan." },
      { kind: "order", tr: "Kitabın sonu harika.", answer: "The end of the book is great.", extra: ["book's"], explain: "Eşya: the end **of** the book." },
  ...
  "possessive-adjectives": {
    ...
    quiz: [
      { kind: "choice", prompt: "[I] love ___ job.", tr: "İşimi seviyorum.", options: ["my", "me", "mine"], answer: 0, explain: "I → **my**." },
      ...
      { kind: "type", prompt: "[We] love ___ new flat.", tr: "Yeni dairemizi çok seviyoruz.", answer: ["our"], explain: "We → **our**." },
      { kind: "type", prompt: "[Mert] can't find ___ phone.", tr: "Mert telefonunu bulamıyor.", answer: ["his"], explain: "Mert erkek → **his**." },
      { kind: "choice", prompt: "Hangisi doğru?", options: ["What's you name?", "What's your name?", "What's yours name?"], answer: 1, explain: "İsimden önce sahiplik: **your** name." },
      { kind: "order", tr: "Onların evi çok büyük.", answer: "Their house is very big.", extra: ["There"], explain: "Sahiplik: **Their** house." },
      { kind: "order", tr: "Kedi kuyruğuyla oynuyor.", answer: "The cat is playing with its tail.", extra: ["it's"], explain: "Hayvanın sahipliği: **its**." },
  ...
  "have-got": {
    ...
    quiz: [
      ...
      { kind: "choice", prompt: "___ [you] got a pen?", tr: "Kalemin var mı?", options: ["Do", "Have", "Has"], answer: 1, explain: "have got sorusu: **Have** you got…?" },
      ...
      { kind: "choice", prompt: "Hangisi doğru?", options: ["Do you have got a dog?", "Have you got a dog?", "Have you a dog got?"], answer: 1, explain: "**Have** you **got** a dog?" },
      { kind: "order", tr: "Başım ağrıyor.", answer: "I have got a headache.", also: ["I've got a headache."], extra: ["has"], explain: "Hastalıklar da sahiplik: I **have got** a headache." },
      { kind: "order", tr: "Kız kardeşimin uzun saçları var.", answer: "My sister has got long hair.", extra: ["have"], explain: "My sister = she → **has got**." },
  ...
  jobs: {
    ...
    quiz: [
      ...
      { kind: "choice", prompt: "I'm ___ student.", tr: "Öğrenciyim.", options: ["a", "an", "—"], answer: 0, explain: "student sessiz harfle başlıyor: **a**." },
      { kind: "choice", prompt: "Who cuts your hair?", tr: "Saçını kim keser?", options: ["a hairdresser", "a dentist", "an accountant"], answer: 0, explain: "**Hairdresser** = kuaför." },
      ...
      { kind: "order", tr: "Kız kardeşim bir avukat.", answer: "My sister is a lawyer.", extra: ["an"], explain: "lawyer sessizle başlıyor: **a** lawyer." },
      { kind: "order", tr: "Onlar hemşire.", answer: "They are nurses.", extra: ["a"], explain: "Çoğulda a yok: They are **nurses**." },
      { kind: "choice", prompt: "Hangisi doğru?", options: ["She's a artist.", "She's an artist.", "She's artist."], answer: 1, explain: "artist sesli harfle başlıyor: **an** artist." },
    ],
  },
};
